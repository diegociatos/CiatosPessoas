...
import { User, LogOut, RefreshCw, ShieldCheck, ChevronDown, X, Star } from 'lucide-react';
      ...
      <div className="fixed top-0 left-0 right-0 h-14 ciatos-navy border-b-2 border-ciatos-gold z-[100] flex items-center justify-between px-8 shadow-2xl">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black text-white uppercase tracking-[0.3em]">Ciatos People Engine</span>
          </div>
          ...
          <div className="flex items-center gap-3 ml-4">
            ...
            <span className="px-2 py-0.5 bg-white/5 border border-white/10 rounded-md text-[9px] font-black text-gray-300 uppercase tracking-widest">{user.role}</span>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
          <div className="bg-white w-full max-w-lg rounded-[2.5rem] shadow-2xl overflow-hidden">
            <div className="p-8 ciatos-navy text-white flex justify-between items-center">
              <div>
                <h3 className="text-xl font-black tracking-tight">Mudar Contexto de Acesso</h3>
                <p className="text-[10px] text-ciatos-gold font-black uppercase tracking-widest mt-1">Ambiente de Simulação de Perfis</p>
              </div>
            ...
            <div className="p-8 space-y-4">
              {PREDEFINED_USERS.map((u) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-xl bg-slate-100 flex items-center justify-center font-black text-ciatos-navy group-hover:bg-ciatos-navy group-hover:text-white transition-all">
                      {u.name[0]}
                    </div>
              ...
              <div className="pt-6 border-t border-gray-100">
                ...
                >
                  <LogOut size={16} /> Encerrar Sessão do Sistema
                </button>
              </div>
            </div>
          </div>
